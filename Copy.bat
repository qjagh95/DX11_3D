...
xcopy .\Engine\Bin\*.* .\Rapper\Bin\ /s /y /d /exclude:exclude.txt
xcopy .\Engine\Bin\*.* .\WFEditor\bin\Debug\ /s /y /d /exclude:exclude.txt
xcopy .\Engine\Bin\*.* .\WFEditor\bin\Release\ /s /y /d /exclude:exclude.txt